...
var Chunk = require('./chunk'),
  ...
  Int32 = require('mongodb-core').BSON.Int32,
...
var writeFile = function(self, file, callback) {
  ...
  self.open(function (err, self) {
    ...
    fs.fstat(file, function (err, stats) {
     ...
     // add by fish
      var simultaneouslyChunkWrite = 10;
      // fix Int32 object bug
      var chunkSize = self.chunkSize && self.chunkSize.valueOf() || 255 * 1024;
      // end
      var numberOfChunksLeft = Math.min(stats.size / chunkSize);
      ...
      var writeChunk = function() {
        ...
        fs.read(file, chunkSize, offset, 'binary', function(err, data, bytesRead) {
          if(err) return callback(err, self);
          ...
          chunk.write(data, function(err, chunk) {
            ...
            chunk.save({}, function(err) {
              ...
              if(isEnd) {
                ...
                //edit by fish
                return simultaneouslyChunkWrite++;
                //end
              }
            });
          });
...
var read = function(self, length, buffer, callback) {
  ...
  if (finalLength instanceof Long){
      finalLength = finalLength.toNumber();
  }
  // edit by fish
  // if (finalLength instanceof Int32){
  //     finalLength = finalLength.valueOf();
  // }
  // end

  // edit by qinghai
  if (finalLength && finalLength["valueOf"]){
      finalLength = finalLength.valueOf();
  }
  // end
